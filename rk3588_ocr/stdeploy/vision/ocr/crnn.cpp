...
namespace stdeploy {
    namespace vision {
        namespace ocr {
            ...
            CRNN::CRNN(const std::string &model_file, const std::string &params_file,
            ...
            bool CRNN::Init() {
                ...
                postprocessor_ = new CRNNPostprocessor(config_file_);
            ...
            bool CRNN::Predict(sd::Mat &img, OCRResult *result) {
                bool ret = false;
