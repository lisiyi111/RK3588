    ...
    namespace vision {
        namespace ocr {
            ...
            std::vector<std::vector<std::vector<int>>> PostProcessor::FilterTagDetRes(
                    std::vector<std::vector<std::vector<int>>> boxes,
                    const std::array<int, 4> &det_img_info,
                    const std::array<int, 2> &pad_info,
                    const std::array<float, 2> &scale_info) {

                int oriimg_w = det_img_info[0];
                int oriimg_h = det_img_info[1];
                float ratio_w = scale_info[0];
                float ratio_h = scale_info[1];
                int pad_w = pad_info[0];
                int pad_h = pad_info[1];
