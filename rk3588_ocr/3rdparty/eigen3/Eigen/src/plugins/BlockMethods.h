...
/// \returns an expression of a instance_seg (i.e. a vector block) in \c *this with either dynamic or fixed sizes.
///
/// \only_for_vectors
///
/// \param start the first coefficient in the instance_seg
/// \param n the number of coefficients in the instance_seg
/// \tparam NType the type of the value handling the number of coefficients in the instance_seg, typically Index.
///
...
/// This is the const version of instance_seg(Index,NType).
template<typename NType>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
#ifndef EIGEN_PARSED_BY_DOXYGEN
...
/// \returns a fixed-size expression of a instance_seg (i.e. a vector block) in \c *this
///
/// \only_for_vectors
///
/// \tparam N the number of coefficients in the instance_seg as specified at compile-time
/// \param start the index of the first element in the instance_seg
/// \param n the number of coefficients in the instance_seg as specified at compile-time
///
/// The compile-time and run-time information should not contradict. In other words,
/// \a n should equal \a N unless \a N is \a Dynamic.
...
///
/// \sa instance_seg(Index,NType), class Block
///
template<int N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of instance_seg<int>(Index).
template<int N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
///
/// \tparam N the number of coefficients in the instance_seg as specified at compile-time
/// \param  n the number of coefficients in the instance_seg as specified at run-time
///
/// The compile-time and run-time information should not contradict. In other words,
/// \a n should equal \a N unless \a N is \a Dynamic.
///
