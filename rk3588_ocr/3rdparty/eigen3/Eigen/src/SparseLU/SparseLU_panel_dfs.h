  ...
  else 
  {
    ...
    else 
    {
      ...
      do 
      {
        ...
        //    instance_seg is seen for the first time. (Note that
 ...
 * the panel.
 * The location of the first nonzero in each supernodal instance_seg
 ...
 * \param[out] segrep Segment representative i.e first nonzero row of each instance_seg
