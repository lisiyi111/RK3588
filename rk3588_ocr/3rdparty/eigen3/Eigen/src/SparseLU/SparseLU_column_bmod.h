 ...
 * \param segrep instance_seg representative ...
                                                     ...
                                                     BlockIndexVector segrep, BlockIndexVector repfnz, Index fpanelc, GlobalLU_t& glu)
{
  ...
  /* krep = representative of current k-th supernode
    ...
    * kfnz = first nonz in the k-th supernodal instance_seg
    * no_zeros = no lf leading zeros in a supernodal U-instance_seg
    */
  
  jsupno = glu.supno(jcol);
  // For each nonzero supernode instance_seg of U[*,j] in topological order
  k = nseg - 1; 
